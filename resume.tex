...
\begin{cventries}
  ...
  {\begin{cvitems}
    ...
    \item {Shipped complete backend infrastrastructure for an innovative car-sharing app}
    \end{cvitems}}
  \cventry
  ...
  {\begin{cvitems}
	...
	{\begin{cvitems}
		\item {Implemented most crucial user interfaces in the React application, configured internal logic and data flow}
		\end{cvitems}}
  \cventry
  {Software Developer}
  {eoSurgical}
...
\begin{cventries}
	...
	{\def\arraystretch{1.15}{\begin{tabular}{ l l }
		Programming Languages:  & {\skill{ JavaScript, Java, Kotlin, Python, C++, C, bash}} \\
    Frameworks and tools: & {\skill{ NodeJS, ExpressJS, GraphQL, ReactJS, Redux, Flow, Jest}} \\
    ...
    Mobile: & {\skill{ React Native, Android}} \\
